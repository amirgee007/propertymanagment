...
<!-- START @META SECTION -->
    ...
    <title>MEMBER AREA | BLANKON - Fullpack Admin Theme</title>
    <!--/ END META SECTION -->
...
<div id="sign-wrapper">
    ...
    <!-- Login form -->
    <form class="sign-in form-horizontal shadow no-overflow" action="dashboard.html" method="post">
        ...
        <div class="sign-body">
            <div class="form-group">
                <div class="input-group input-group-lg rounded no-overflow">
                    <input type="text" class="form-control input-sm" placeholder="Username or email " name="username" value="admin@djavaui.com">
                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                </div>
            </div><!-- /.form-group -->
            <div class="form-group">
                <div class="input-group input-group-lg rounded no-overflow">
                    <input type="password" class="form-control input-sm" placeholder="Password" name="password" value="blankon">
    ...
    <!-- Content text -->
    <p class="text-muted text-center sign-link">Powered By <a href="http://djavaui.com" target="_blank"> Djava UI</a></p>
    <!--/ Content text -->
