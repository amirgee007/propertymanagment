    ...
    <section id="page-content">
        <div class="header-content">
            ...
            <div class="breadcrumb-wrapper hidden-xs">
                ...
                <ol class="breadcrumb">
                    <li class="active">Edit Sinking Funds</li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="panel rounded shadow">
                        <div class="panel-body no-padding">
                            <form class="form-horizontal form-bordered" action="{{ route('sinking-funds.update', $fund) }}"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <textarea class="form-control" name="description" rows="5">{{ $fund->description }}</textarea>
                                        </div>
                                    </div><!-- /.form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" value="{{ $fund->date ? $fund->date->format('d-m-Y') : null }}" name="date" id="dp1">
                                ...
                                <div class="form-footer">
                                    <div class="col-sm-offset-3">
                                        <button type="submit" class="btn btn-theme">Update Fund</button>
