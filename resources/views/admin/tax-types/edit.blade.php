                    ...
                    <div class="panel rounded shadow">
                        <div class="panel-body no-padding">
                            <form class="form-horizontal form-bordered"
                                  action="{{ route('tax-types.update', $taxType) }}"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" value="{{ $taxType->name }}" class="form-control" name="name">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Rate<small> %</small><span
                                                    class="asterisk">*</span></label>
                                        <div class="col-sm-7">
                                            <input type="number" value="{{ $taxType->rate }}" class="form-control" name="rate">
                                        </div>
                                    </div><!-- /.form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="ckbox ckbox-theme rounded">
                                                <input id="checkbox-type-rounded1" type="checkbox" {{ $taxType->status == 1 ? 'checked' : null }} name="status">
                                ...
                                <div class="form-footer">
                                    <div class="col-sm-offset-3">
                                        <button type="submit" class="btn btn-theme">Update Tax</button>
