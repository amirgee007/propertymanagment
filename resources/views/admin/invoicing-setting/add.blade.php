                                ...
                                <div class="col-md-12">
                                    <div class="panel rounded shadow">
                                        <div class="panel-heading">
                                            <div class="pull-left">
                                                <h3 class="panel-title">Invoicing Setting <small>Add New Here</small></h3>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="panel-body no-padding">
                                            <form class="form-horizontal form-bordered" method="post" role="form" id="form-invoicing-setting" action="{{route('invoicing-setting.edit')}}">
                                                <div class="form-body">
                                                    {{csrf_field()}}
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title">
                                                                                <i style="font-size:16px;" class="fa fa-info-circle"></i> General</h4>
                                                                        </div>
                                                        ...
                                                        <div class="bs-example-modal">
                                                            <div class="modal modal-warning">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title"><i style="font-size:16px;" class="fa fa-info-circle"></i> Utility settings</h4>
                                                                        </div>
                                                                        <div class="modal-body">
                                                        ...
                                                        <div class="bs-example-modal">
                                                            <div class="modal modal modal-teal">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title"><i style="font-size:16px;" class="fa fa-info-circle"></i> Maintenance/Service settings</h4>
                                                                        </div>
                                                                        <div class="modal-body">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-theme">Change Invoicing System</button>
                                                </div>
                                            </form>
                                        </div><!-- /.panel-body -->
                                    </div><!-- /.panel -->
