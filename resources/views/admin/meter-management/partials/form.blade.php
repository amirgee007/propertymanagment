...
<div class="form-group">
    ...
    <div class="col-sm-7">
        <input type="text" class="form-control input-sm" name="meter_code">
    </div>
</div><!-- /.form-group -->
...
<div class="form-group">
    ...
    <div class="col-sm-7">
        <input type="text" class="form-control input-sm" name="minimum_charges">
    </div>
</div><!-- /.form-group -->
...
<div class="form-group">
    ...
    <div class="col-sm-7">
        <div class="ckbox ckbox-theme rounded">
            <input id="checkbox-type-rounded1" type="checkbox" onclick="toggle('.tax-value', this)" name="is_taxable">
...
<div class="tax-value" style="display: none">
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control input-sm" name="tax_amount">
        </div>
    </div>
</div>
...
<div class="form-footer">
    <div class="col-sm-offset-3">
        <button type="submit" class="btn btn-theme">Save Meter</button>
    </div>
</div>
